...
public:
    ...
    void setDrawRect(const QRect &rect); //绘制矩形的区域

protected:
    void paintEvent(QPaintEvent *);
    void drawBg(QPainter *painter);
    void drawText(QPainter *painter);
    void drawNameText(QPainter *painter);
private:
    int totalNum;       //总数
...
public slots:
    ...
    //设置当前图片名称
    void setCurrentName(QString currentName);
};
...
signals:
    ...
    //当前图片名字发生改变时触发
    void currentNameChanged(QString currentName);
